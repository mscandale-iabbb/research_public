	...
	if (count($rs) > 0) {
		...
		foreach ($rs as $k => $fields) {
			...
			$processed_button = "<a class=cancel_button_small " .
				"onclick=\" if (confirm('The overview text for this business has been corrected and " .
			...
			$invalid_button = "<a class=cancel_button_small " .
				"onclick=\" if (confirm('The overview text for this business has been found to be NOT a problem and " .
