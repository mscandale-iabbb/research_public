...
class NcBureauAlcoholTobaccoFirearmsExplosivesSpider(scrapy.Spider):
    name = 'nc_bureau_alcohol_tobacco_firearms_explosives'
    allowed_domains = ['atf.gov']
    start_urls = ['https://www.atf.gov/firearms/listing-federal-firearms-licensees/state?field_ffl_date_value%5Bvalue%5D%5Byear%5D=&ffl_date_month%5Bvalue%5D%5Bmonth%5D=&field_state_value=NC']
